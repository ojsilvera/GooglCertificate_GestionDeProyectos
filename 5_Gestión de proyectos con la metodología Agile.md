...
El término "valor" puede significar diferentes cosas para cada cliente en función de lo que esperan que el producto logre,
El principio Agile número uno es satisfacer al cliente mediante la entrega de software valioso. Puedes reemplazar el término
“software” con las palabras “producto” o “solución” para proyectos no relacionados con el software.

Entregar valor rápido y con la mayor eficiencia posible a los usuarios es la razón principal por la que se desarrolló Agile,
El término "entrega impulsada por el valor" significa que tú y tu equipo están enfocados en entregar un producto de alto
valor. Solo porque entregas un producto, eso no significa que sea valioso. Exsistia un problema creciente de equipos de
proyecto que fabricaban productos que no eran muy valiosos. Esto se debe a que los equipos se centraron en el proceso y
no se tomaban el tiempo para evaluar la utilidad del producto hasta el final, después de haber sido entregado. Agile
redirige el enfoque del equipo para que esté puesto en el producto y asegura que el proceso de producción del producto
apoye el objetivo de entregar valor.

¿Cómo puedes asegurarte de que tu equipo esté centrado en la entrega impulsada por el valor? Desarrollar lo correcto y
ejecutarlo bien. Recuerda que Agile y Scrum surgieron de la industria del software. Los términos "desarrollar" y "ejecutar"
describen procesos para crear o ejecutar un programa de software, máquina u otra tecnología. Puedes reemplazar las palabras
"desarrollar" y "ejecutar" por términos como "crear", "producir" o "entregar" para proyectos que no son de software a fin
de describir el mismo concepto.

En primer lugar, para *ofrecer valor*, tienes que desarrollar lo correcto. Para estar seguro, debes entender realmente lo
que quieren tus clientes. Puedes preguntarle al cliente qué quiere, y tal vez te diga que quiere desarrollar un sitio web
para promocionar su nuevo servicio de planta. Puedes ir un poco más allá y preguntar acerca de sus objetivos:

    ¿Quieren aumentar el reconocimiento de su marca?
    ¿Quieren conseguir más clientes?

Tener una conversación orientada a la solución con tu cliente te ayudará a desarrollar lo correcto. El valor de Agile de

    "individuos e interacciones sobre procesos y herramientas"

se extiende más allá del equipo. Se refiere a tener esas interacciones importantes con nuestros clientes y usuarios también.

A continuación, debes *desarrollar con dedicación*. Esa es la jerga para asegurarte de que tu equipo solo desarrolle las
características solicitadas o aprobadas. Trabajar en funcionalidades que no son necesarias puede conducir a complejidades
en el producto que no aportan ningún valor a los usuarios. Además, desarrollar más de lo que necesitas retrasa o reduce
tu valor en el momento de la entrega. También aumenta el riesgo de experimentar errores u otros problemas en el camino.

Finalmente, además de desarrollar lo correcto, tienes que *asegurarte de que lo estás haciendo bien*. Ejecutarlo bien
significa que tu equipo ha pensado bien en cómo el usuario interactuará con el producto una vez entregado. Asegúrate de
que tu equipo piense en algunas de las tareas operativas que deberán abordarse después de que el producto haya salido de
las instalaciones.

Responde las preguntas siguientes:

    ¿Cómo obtienen soporte los usuarios?
    ¿Cómo agrega valor el producto a los usuarios mucho después de haberlo recibido inicialmente?
    ¿Cómo te aseguras de que las nuevas funcionalidades y capacidades lleguen a los usuarios existentes?

Al desarrollar lo correcto, hacerlo con dedicación y ejecutarlo bien todos trabajan juntos para asegurar que el equipo
genere una entrega constante y continua de valor a los usuarios a lo largo de la vida útil del producto.

*En resumen:*

¿Qué es el valor?

    El valor es lo que hace que un producto o servicio sea útil y deseable para los usuarios.
    Puede ser financiero, de crecimiento, de compromiso o de cumplimiento.

¿Por qué es importante el valor en Agile?

    Agile se centra en entregar valor a los usuarios lo más rápido y eficientemente posible.
    La "entrega basada en el valor" significa que el equipo se centra en entregar un producto de alto valor.

Cómo entregar valor?

    Construye lo correcto: Entiende lo que los clientes quieren y necesitan.
    Construye lo correcto: Asegúrate de que el equipo solo construya las características necesarias.
    Ejecútalo correctamente: Piensa en cómo los usuarios interactuarán con el producto después de su entrega.

Ejemplo de Virtual Verde

    Construir lo correcto: Encuesta a los clientes para determinar sus preferencias de plantas y diseño.
    Construir lo correcto: Asegúrate de tener un proveedor de plantas confiable y trabaja con diseñadores para crear macetas
    y accesorios.
    Ejecutarlo correctamente: Envía encuestas de satisfacción del cliente y ofrece apoyo continuo.

#### Caso práctico: Formar un grupo de trabajo impulsado por valores

Aprender de los estudios de casos

A medida que avanzas en tu carrera en gestión de proyectos, encontrarás muchos recursos para aprender sobre otras empresas
y sus recorridos para convertirse en Agile.

Los casos prácticos (análisis detallados basados en datos de una empresa, comunidad u organización) son herramientas valiosas
para obtener información clave de la industria y aprender de los éxitos y fracasos de tus competidores.

Cuando leas los casos prácticos, concéntrate en el problema, el efecto que tuvo en la empresa u organización y los pros y
los contras de las soluciones alcanzadas para ayudarlo a determinar algunos puntos clave aplicables.

Mientras lees, pregúntate:
    ...
    ¿Qué hechos clave deben considerarse?

    ¿Qué alternativas están disponibles para el responsable de tomar decisiones?

    ¿Que recomendarías y por qué?
...
Como Scrum Master o gerente de proyectos Agile, tu función es ayudar al equipo a mejorar. Esto implica:

    Diseñar las "jugadas" con el equipo: Crea un plan de juego que incluya cómo ejecutar las revisiones de Sprint, el
    trabajo diario y la publicación de planes para las partes interesadas.

    Proporcionar comentarios al equipo: Ofrece orientación y retroalimentación continuas para ayudar al equipo a identificar
    áreas de mejora e implementar soluciones.

    Celebrar y aprender con el equipo: Reconoce los logros, aprende de los errores y fomenta una mentalidad de mejora continua.
...
Los tres desafíos en los que nos centraremos son:

    la gestión de una hoja de ruta de productos estable
    la implementación incompleta de Scrum
    la falta de estabilidad dentro del equipo. Primero, analicemos el desafío de administrar

una hoja de ruta de productos estable:

Los proyectos de Agile casi siempre experimentan cambios en la hoja de ruta del producto. Ser capaz de responder rápida y
productivamente a estos cambios es un valor central de Agile. Pero es posible que haya demasiados cambios que afecten al
proyecto, lo que puede conducir a una hoja de ruta del producto inestable.

Hay dos causas principales de una hoja de ruta de producto inestable:

    ambición de producto y supuestos del producto.

Primero hablemos de la ambición del producto. La ambición del producto plantea un desafío cuando el liderazgo del producto
es demasiado ambicioso sobre lo que el equipo puede ofrecer de manera realista. El propietario del producto es responsable
de representar el proyecto ante los clientes y ejecutivos porque el propietario del producto quiere hacer felices a los
interesados. Puede ser fácil para ellos prometer demasiado respecto de lo que puede ofrecer el proyecto.
...
#### La evolución de Agile

Hola de nuevo. Desde su creación en 2001, la popularidad de la metodología Agile ha aumentado increíblemente rápido. Un informe de la industria mostró que el 85 por ciento de las organizaciones han adoptado un modelo centrado en el producto, que está asociado con un enfoque Agile. El informe del estado de Agile describe cómo el 30 por ciento de dichas empresas que utilizan el modelo centrado en el producto aplican una combinación de metodologías. Esto significa que ser capaz de combinar métodos será una habilidad súper útil para comenzar tu carrera de gestión de proyectos. Como explicamos en un video anterior, una de las razones de la creciente popularidad de Agile es que estamos en un mundo muy VUCA. Las empresas enfrentan mucha volatilidad, incertidumbre, complejidad y ambigüedad, y reconocen que Agile y el framework que se derivan de ella son una forma de superar esos desafíos. En este video, analizaremos cómo Agile ya ha comenzado a evolucionar y explorar algunas ideas emergentes sobre cómo podría seguir evolucionando en el futuro. El Manifiesto Agile como mentalidad o filosofía no ha cambiado mucho en casi 30 años. Sin embargo, los frameworks que inspiró han seguido cambiando y evolucionando para mantenerse al día con los entornos comerciales cambiantes. Un framework Agile emergente se llama DevOps, que combina el desarrollo de software y las operaciones de TI. Nuestro negocio de Google Cloud Platform define DevOps como un movimiento organizativo y cultural que tiene como objetivo aumentar la velocidad de entrega del software, mejorar la confiabilidad del servicio, y crear propiedad compartida entre los interesados del software. Como todos los frameworks Agile, DevOps tiene como objetivo acortar el ciclo de vida del producto y entregar productos de software de forma permanente y con muy alta calidad. DevOps surgió cuando las empresas de software debían tratar de averiguar cómo asegurarse de que sus productos de software funcionasen de manera fiable para miles de millones de personas en todo el mundo, las 24 horas del día, siete días a la semana. Como alguien que dedicó sus primeros años en Google a estudiar averías de productos, puedo decir lo difícil que es esto. Si un negocio tiene la capacidad de lanzar productos y funciones de manera rápida y confiable a un mercado global, tiene una ventaja competitiva significativa. DevOps se trata de crecer y gestionar equipos y organizaciones que puedan desarrollar y evolucionar sistemas a gran escala a un ritmo rápido. Estos sistemas deben ser seguros y confiables, para ofrecer mayor valor a clientes y organizaciones. Si decides ocupar un rol de gerente de proyectos en el marco DevOps, te aventurarás en el futuro de los enfoques Agile y en los sistemas de software a gran escala que están literalmente cambiando el mundo. Suena emocionante, ¿no? Una de las próximas fronteras de la metodología Agile se llama agilidad empresarial, que implica incorporar principios Agile en la amplia esfera de gestión, para que la organización puede prosperar en entornos de alto VUCA. Las organizaciones que quieren adoptar la metodología Agile en este sentido a menudo vuelven a analizar todo, desde los procesos de planificación financiera, las estructuras de gobierno y presentación de informes, hasta las prácticas de contratación y recursos humanos, y mucho más. Buscan distintas maneras de hacer que los valores Agile y los frameworks funcionen para organizaciones cada vez más grandes. Como gerente de proyectos de Agile en una organización más grande, es posible que uses frameworks como Scrum de Scrums o Framework de metodología Agile escalado, también conocido como SAFe. Consulta los recursos y las lecturas de este video para obtener más información. También es importante señalar que Agile ha llegado a muchas industrias más allá de la tecnología y el software. Recientemente, me pidieron que impartiera formación sobre la metodología Agile al equipo de ventas de Google en América Latina. Experimentaron grandes cambios en su mercado y querían desarrollar las habilidades necesarias para reaccionar rápidamente a esos cambios y seguir ofreciendo resultados. Durante la capacitación, mantuvimos excelentes debates sobre los beneficios de Agile. Al equipo le gustó especialmente cómo Agile puede ayudar a reducir el riesgo en todas las etapas del ciclo de ventas, mediante la retroalimentación temprana y las discusiones frecuentes y exhaustivas con compañeros y clientes. Incluso la industria de la construcción ha comenzado a aplicar un enfoque Agile a sus proyectos. Un artículo publicado por Project Management Institute describe cómo se usó Agile en los proyectos de construcción para abordar las demoras y los sobrecostos al traducir el Manifiesto Agile en términos de la industria de la construcción, como: silos que se minimizan e impulso de la cooperación estrecha. Finalmente, las metodologías Agile también pueden aplicarse a tu propia vida personal. Por ejemplo, hace poco, estaba planeando una mudanza y creé de inmediato un tablero Kanban para empezar a planificar mis tareas. ¿Tienes algún proyecto en tu vida en el que puedas usar un tablero Kanban? ¿Qué tal una limpieza de garaje? ¿O una reunión familiar o barbacoa? ¿Quién está en tu equipo de Scrum? Desde DevOps y agilidad empresarial hasta las metodologías Agile en la industria de la construcción y más allá, está claro que los beneficios de Agile serán útiles durante mucho tiempo. Los practicantes, gerentes de proyectos y los equipos que viven y aplican los valores Agile son los que ayudan a Agile a evolucionar y avanzar, lo que significa que puedes desempeñar un papel importante y hacer un aporte al futuro de Agile. Próximamente, analizaremos cómo abordar tu búsqueda de empleo para que puedas encontrar una oportunidad en la gestión de proyectos con metodología Agile. Nos vemos ahí.

En resumen:

- Agile ha ganado popularidad rápidamente debido a su capacidad para abordar los desafíos de los entornos VUCA (volatilidad,
  incertidumbre, complejidad y ambigüedad).

- Los marcos de trabajo de Agile, como Scrum y DevOps, han evolucionado para mantenerse al día con los entornos empresariales
  cambiantes.

- DevOps combina el desarrollo de software y las operaciones de TI para mejorar la velocidad de entrega de software, la
  confiabilidad del servicio y la propiedad compartida.

- La agilidad empresarial incorpora los principios de Agile en la gestión para que las organizaciones prosperen en entornos
  VUCA.

- Agile se ha extendido más allá de la tecnología y el software, aplicándose en industrias como la construcción y las ventas.

- Las metodologías de Agile también se pueden aplicar a la vida personal para mejorar la planificación y la productividad.
